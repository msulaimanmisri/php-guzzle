...
<head>
    ...
    <link rel="icon" href="https://sulaimanmisri.com/Favicon-sm.png" />
                ...
                <div class="row h-100">
                    ...
                    if (!empty($error)) {
                        ...
                        foreach ($result['results'] as $photo) {
                            ...
                            echo '<div class="col-12 col-md-3 py-2">';
                            echo '<img src="' . $imageUrl . '" alt="unsepelesh-image" class="unsepelesh-img-size rounded-3 shadow-sm" loading="lazy">';
                            echo '</div>';
                        }
                    }
                    ?>
